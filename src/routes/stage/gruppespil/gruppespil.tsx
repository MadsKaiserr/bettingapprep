                ...
                <div className="gruppespil-container">
                    <div className="gruppespil-section">
                        ...
                        <div className="gruppespil-info" id="inviteInfo">
                            ...
                            <div className="opret-element-input gruppespil-invite" onClick={() => {navigator.clipboard.writeText("http://localhost:3000/stage/gruppesession?game=" + activeGame + "&type=invite"); document.getElementById("copied").classList.toggle("display-not")}}>
