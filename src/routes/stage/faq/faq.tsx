                ...
                <div className="faq-container">
                    ...
                    <div className="faq-element" onClick={() => {showQuestion("q2")}}>
                        ...
                        <div className="faq-answer" id="q2-a">
                            <p className="faq-a-p">Hvis alle kampe i din kupon er færdigspillede, får du din udbetaling næste gang dig, eller en af dine venner, logger ind på gruppespillet kuponnen er placeret i.</p>
