        ...
        <div className="find-div">
                <div className="gruppespil-top">
                    ...
                    <div className="aktivespil-nav">
                        <button className="aktivespil-element-active">Alle gruppespil</button>
                        <button className="aktivespil-element">Private spil</button>
                        <button className="aktivespil-element">Offentligt spil</button>
                        <button className="aktivespil-element">Præmieturneringer</button>
                    </div>
                </div>
