...
function StageMatcharticle () {
    ...
    const [senesteHome, setSenesteHome] = useState([]);
    const [senesteVisitor, setSenesteVisitor] = useState([]);
    ...
    const [visitorplace, setvisitorplace] = useState("");
    const [time, settime] = useState("");
    const [live, setlive] = useState("match-stilling-p1");
    const [livedisplay, setlivedisplay] = useState("display-not");
    const [livestilling, setlivestilling] = useState("display-not");
    const [matchdate, setmatchdate] = useState(0);

    const queryString = window.location.search;
    const urlParams = new URLSearchParams(queryString);
    const matchID = urlParams.get("game");
    ...
    function getGame() {
        ...
        .then(function (result) {
            ...
            setLeagueId(result.data.league_id);
            ...
            if (result.data.round_id !== null) {
                setRound_id(result.data.round.data.name);
            }
            var homegoal1 = 0;
            var awaygoal1 = 0;
            var homegoal2 = 0;
            ...
            sethomescore(result.data.scores.localteam_score);
            setvisitorscore(result.data.scores.visitorteam_score);
            sethomelogo(result.data.localTeam.data.logo_path);
            setvisitorlogo(result.data.visitorTeam.data.logo_path);
            sethomeplace(result.data.standings.localteam_position);
            setvisitorplace(result.data.standings.visitorteam_position);
            ...
            if (result.data.time.status === "LIVE" || result.data.time.status === "FT") {
            ...
            if (result.data.time.minute !== null && result.data.time.status === "LIVE") {
                if (result.data.time.minute <= 45) {
                    settime("1. HALVLEG - " + result.data.time.minute + ". MIN");
                } else if (result.data.time.minute >= 45){
                    settime("2. HALVLEG - " + result.data.time.minute + ". MIN");
                }
                ...
                var returnMonth = "" + startDate.getMonth();
                                                    ...
                                                    {res.standings.data.map((thirdRes) => {
                                                        ...
                                                        return (
                                                            <li key={thirdRes.round_id + "-" + thirdRes.team_name + thirdRes.position}>
                                                                <Link to={"/stage/team?team=" + thirdRes.team_id} className={"tabel-element " + thoseClass} style={{borderLeft: "4px solid var(--primary)", paddingLeft: "11px"}}>
                                                                    <div className="tabel-ends">
                                        ...
                                        {item.standings.data.map((fres) => {
                                            ...
                                            return (
                                                <li key={fres.round_id + "-" + fres.team_name}>
                                                    <Link to={"/stage/team?team=" + fres.team.data.id} className={"tabel-element " + thoseClass} style={{borderLeft: "4px solid var(--primary)", paddingLeft: "11px"}}>
                                                        <div className="tabel-ends">
        ...
        if (localStatArray["corners"] !== undefined && visitorStatArray["corners"] !== undefined) {
            ...
            return (
               <div className="stats-container">
                    <div className="stats-element" style={possessiontime_show}>
                        <p className="stats-h1">Boldbesiddelse</p>
                        <div className="stats-stat">
                            <div className="stats-left" style={possessiontime_str_l_style}>
                                <p className="stats-p">{possessiontime_str_l}</p>
                            </div>
                            <div className="stats-right" style={possessiontime_str_v_style}>
                                <p className="stats-p">{possessiontime_str_v}</p>
                            </div>
                        </div>
                    </div>
                    <div className="stats-element" style={shots_show}>
                    ...
                    <div className="stats-element" style={ongoal_show}>
                    ...
                    <div className="stats-element" style={freekick_show}>
                    ...
                    <div className="stats-element" style={offsides_show}>
    ...
    const [oddNav, setOddNav] = useState("");
    ...
    useEffect(() => {
        if (oddNav === "popular") {
            ...
            document.getElementById("specials").classList.remove("display");
            document.getElementById("minutter").classList.remove("display");
            ...
            document.getElementById("goal").classList.remove("display");
            document.getElementById("spillere").classList.remove("display");
            document.getElementById("specials").classList.add("display");
            document.getElementById("minutter").classList.remove("display");
            ...
            document.getElementById("spillere").classList.remove("display");
            document.getElementById("specials").classList.remove("display");
            document.getElementById("minutter").classList.add("display");
    ...
    function getLineup() {
        ...
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 1 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 1 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //                 <div className="st-section">
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 5 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 5 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 4 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 4 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 3 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 3 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 2 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 2 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //                 <div className="st-section">
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 8 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 8 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 7 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 7 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 6 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 6 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //                 <div className="st-section">
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 11 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 11 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 10 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 10 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 9 && object.team_id === homeTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 9 && object.team_id === homeTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //                 <div className="st-section">
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 9 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 9 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 10 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 10 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 11 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 11 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //                 <div className="st-section">
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 6 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 6 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 7 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 7 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                         <img src="" alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 8 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 8 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //                 <div className="st-section">
        //                     <div className="st-player">
        //                     <img src={item[(item.findIndex(object => {return object.formation_position === 2 && object.team_id === visitorTeamId}))].player.data.image_path} alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 2 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 2 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                     <img src={item[(item.findIndex(object => {return object.formation_position === 3 && object.team_id === visitorTeamId}))].player.data.image_path} alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 3 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 3 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                     <img src={item[(item.findIndex(object => {return object.formation_position === 4 && object.team_id === visitorTeamId}))].player.data.image_path} alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 4 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 4 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                     <div className="st-player">
        //                     <img src={item[(item.findIndex(object => {return object.formation_position === 5 && object.team_id === visitorTeamId}))].player.data.image_path} alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 5 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 5 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //                 <div className="st-section">
        //                     <div className="st-player">
        //                         <img src={item[(item.findIndex(object => {return object.formation_position === 1 && object.team_id === visitorTeamId}))].player.data.image_path} alt="" className="st-img" />
        //                         <p className="st-p"><span className="st-p-fat">{item[(item.findIndex(object => {return object.formation_position === 1 && object.team_id === visitorTeamId}))].number}. </span>{item[(item.findIndex(object => {return object.formation_position === 1 && object.team_id === visitorTeamId}))].player_name}</p>
        //                     </div>
        //                 </div>
        //             </>
        //         );
    ...
    function showKupon() {
        document.getElementById("match-kupon").classList.add("match-show");
    }
    function closeKupon() {
    ...
    return (
        <>
            ...
            <div className="stage-main-article-container">
                ...
                <div className="match-info nopadding">
