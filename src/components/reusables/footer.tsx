                ...
                <div className="footer-sections">
                    ...
                    <div className="footer-section-nav">
                        <div className="footer-element">
                            ...
                            <Link to="/about" className="footer-h3">Om os</Link>
                            <a href="https://www.linkedin.com/in/mads-kaiser-90036b236/" target="_blank" className="footer-h3">LinkedIn</a>
                            <Link to="/blog" className="footer-h3">Blog</Link>
                            <Link to="/kontakt" className="footer-h3">Kontakt os</Link>
                        </div>
                        <div className="footer-element">
                            <p className="footer-h2">Platform</p>
                            <Link to="/gruppespil" className="footer-h3">Gruppespil</Link>
                            <Link to="/priser" className="footer-h3">Priser</Link>
                            <Link to="/dyster" className="footer-h3">Præmiedyster</Link>
                            <Link to="/blog" className="footer-h3">Blog</Link>
                        </div>
                        <div className="footer-element">
